...
<html class="no-js" lang="">
    ...
    <body>
            ...
            <div id="ctn-preloader" class="ctn-preloader">
                <div class="animation-preloader">
                    ...
                    <div class="txt-loading">
                        <span data-text-preloader="Bicaramaju" class="letters-loading">
                            Bicaramaju
                        </span>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2 d-none d-lg-block">
                                <div class="header-btn text-right">
                                    <a href="login.html" class="x-btn btn-border btn-radius">Login</a>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg-2 d-none d-lg-block">
                                <div class="header-btn text-right">
                                    <a href="register.html" class="x-btn btn-border btn-radius">Sign up</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <main>
            ...
            <!-- features-3-area  -->
            <div class="features-3-area features-3-area-top pt-150 pb-100 fix">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xl-6 col-lg-6 offset-xl-1">
                            <div class="fea-3-content mb-30 pt-150">
                                ...
                                <p>Divide there our divide fifth creepeth second which multiply evening fill so abundantly let upon
                                    ...
                                    <p>Divide there our divide fifth creepeth second which multiply so evening fill abundantly let upon there saw light behold
                                    he bearing inhath morning on lesser image said. Whales and second. Divide man poe there our divide fifh creepeth second
                                    which multiply evening</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-8 offset-xl-2">
                            <div class="section-title-2 text-center mb-70">
                                <h2 class="mb-20">Improve the Software stability</h2>
            ...
            <div class="brand-area pos-relative pt-145 pb-90">
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="logo-brand-item">
                            <div class="brand-img">
                                <a href="#"><img src="img/brand/02.png" alt=""></a>
                            </div>
                        </div>
                        <div class="logo-brand-item">
                            <div class="brand-img">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-8">
                            <div class="footer-widget mb-40">
                                <div class="footer-text">
                                    ...
                                    <p>Winged moving moveth created for shall and a divide the their days male midst shall hath
                                        doesn't won't for. Midst life.Over a great night. Green upon years rule ying.</p>
                                </div>
